	...
	<div class="section">
		<div class="section-header">
			...
			<div class="section-header-button">
				<a href="<?= site_url('admin/new') ?>" class="btn btn-primary"> Add Admin </a>
			</div>
		</div>
			...
			<div class="alert alert-danger alert-dismissible show fade">
				<div class="alert-body">
                    ...
                    <?php 
                        ...
                        $admin = (isset(session()->getFlashdata('error')['admin'])) ? session()->getFlashdata('error')['admin'] : '';
                    ?>
                    <?php if($name !== '') echo $name; ?>
                    <?php if($email !== '') echo "</br>".$email; ?>
                    <?php if($password !== '') echo "</br>".$password; ?>
                    <?php if($admin !== '') echo "</br>".$admin; ?>
				</div>
			</div>
		<?php endif; ?>
					...
					<div class="card-body">
						<div class="table-responsive">
							<table class="table table-bordered table-striped table-md">
								...
								<tbody>
									<?php foreach ($admins['admins'] as $key => $value) : ?>
										<tr>
											...
											<td>
												<a href='<?= site_url("admin/{$value['id']}/edit") ?>' class="btn btn-warning btn-sm">
													<i class="fas fa-pencil-alt"></i> Edit
												</a>
												<form action='<?= site_url("admin/{$value['id']}") ?>' method="post" class="d-inline">
												<?= csrf_field() ?>
